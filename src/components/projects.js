    ...
    if(this.state.activeTab === 0){
        return(
            <div className="apps">
                    ...
                    <Card  shadow={100} style={{margin:'30px', width: '350px', height: '530px', textAlign: 'center', display: 'inline-block'}}>
                    ...
                    <Card  shadow={100} style={{width: '350px', height: '530px', textAlign: 'center', font:'40px', margin:'30px', display: 'inline-block'}}>
                     ...
                     <Card  shadow={100} style={{display: 'inline-block', width: '350px', height: '530px', textAlign: 'center', margin:'30px'}}>
                    ...
                    <Card  shadow={100} style={{width: '350px', height: '530px', textAlign: 'center', margin:'30px', display:'inline-block'}}>
